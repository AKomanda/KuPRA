      						...
      						<table class="table table-boarded table-stripped">
      							...
      							<tbody>
		      						...
		      						<tr>
		      							...
		      							<td>
		      								<input type="number" min="0.01" value ="<?php if(($item['amount'] - round($item['amount']) != 0)) { round($item['amount'], 2) + 0.01; } else { echo round($item['amount']); } ?>" step="0.01" name ='amount[]' class="form-control">
		      							</td>
